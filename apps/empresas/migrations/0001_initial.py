    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('Física', 'Fisica'), ('Jurídica', 'Juridica')], default='Jurídica', max_length=10, verbose_name='Tipo')),
                ('tipo_participante', models.CharField(choices=[('Cliente', 'Cliente'), ('Fornecedor', 'Fornecedor'), ('Funcionário', 'Funcionario')], default='Cliente', max_length=20)),
                ...
                ('indicador_inscricao_estadual', models.CharField(choices=[('Não contribuinte', 'Não contribuinte'), ('Contribuinte', 'Contribuinte'), ('Contribuinte isento', 'Contribuinte isento')], default='Não contribuinte', max_length=20, verbose_name='Indicador de inscrição estadual')),
                ...
                ('inscricao_SUFRAMA', models.CharField(blank=True, max_length=20, null=True, verbose_name='Inscrição SUFRAMA')),
                ('optante_simples', models.BooleanField(default=False, max_length=1, verbose_name='Optante pelo SIMPLES')),
                ('email', models.EmailField(help_text='Informe apenas um e-mail', max_length=254)),
                ('telefone_comercial', models.CharField(default='(071) 9 9999-9999', max_length=20, verbose_name='Telefone Comercial')),
                ('telefone_celular', models.CharField(default='(071) 9 9999-9999', max_length=20, verbose_name='Telefone Celular')),
                ('data_fundacao', models.DateField(blank=True, default='DD/MM/AAAA', null=True)),
