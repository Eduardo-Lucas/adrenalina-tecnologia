    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ativo', models.CharField(choices=[('Sim', 'Sim'), ('Não', 'Não')], default='Sim', max_length=3)),
                ...
                ('fisica_juridica', models.CharField(choices=[('Física', 'Fisica'), ('Jurídica', 'Juridica')], default='Juridica', max_length=8, verbose_name='Tipo de Cliente')),
