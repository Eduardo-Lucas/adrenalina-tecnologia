    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_pedido', models.CharField(default='w', help_text='status do pedido Orçamento/Devolução/Cancelado/Em análise crédito/Bloqueado/Faturado/quitado/Pré-Pedido etc ', max_length=1, verbose_name='Status deste pedido')),
            ...
            options={
                ...
                'ordering': ['-id'],
                'index_together': {('cliente', 'data_movimento')},
            },
        ),
        migrations.CreateModel(
            name='PedidoItem',
